...
import flag2 from '@/assets/images/flag/icon-flag-th.svg';
...
<template>
    ...
    <v-menu :close-on-content-click="false" location="bottom" class="language_dropdown">
        <template v-slot:activator="{ props }">
            <v-btn icon  size="small" class="custom-hover-primary" v-bind="props">
                <v-avatar size="24">
                    <img v-if="$i18n.locale === 'en'" :src="flag1" :alt="$i18n.locale" width="24" height="24" class="obj-cover" />
                    <img v-if="$i18n.locale === 'th'" :src="flag2" :alt="$i18n.locale" width="24" height="24" class="obj-cover" />

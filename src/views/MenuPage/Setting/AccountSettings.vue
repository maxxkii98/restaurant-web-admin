...
<template>
    ...
    <v-row class="justify-center font-prompt">
        <!--Account Settings tabs-->
        <v-col cols="12" md="12">
            <v-card elevation="10" class=" ">
                <v-tabs v-model="tab" bg-color="transparent" min-height="70" height="70" color="primary">
                    <v-tab value="Account" class="">
                        <UserCircleIcon class="mr-2" size="20" /> ข้อมูลร้านอาหาร
                    </v-tab>
                    <v-tab value="Notification"  class=""><BellIcon class="mr-2" size="20"/>รูป Slider</v-tab>
                    <v-tab value="Bills"  class=""><ArticleIcon class="mr-2" size="20"/>รูป Gallery</v-tab>

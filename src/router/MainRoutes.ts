    ...
    children: [
        {
            ...
            meta: { allowedRoles: ['Administrator', 'SuperUser'] },
        },
        {
            name: 'dashboard 2',
            path: '/dashboard2',
        ...
        },
        {
            name: 'รายการ Event',
            path: '/event',
            component: () => import('@/views/MenuPage/Event/Event.vue'),
        },
        {
            name: 'เพี่ม Event',
            path: '/addevent',
            component: () => import('@/views/MenuPage/AddEvent/AddEvent.vue'),
        },
        {
            name: 'แก้ไข Event',
            path: '/editevent/:id',
            component: () => import('@/views/MenuPage/EditEvent/EditEvent.vue'),
        },
        {
            name: 'จัดการ Table',
            path: '/table',
        ...
        // 
        {
            name: "Staff Scan QR",
            path: "/staff-scan",
            component: () => import("@/views/MenuPage/StaffScan/StaffScan.vue"),
        },
        {
            name: 'Staff Management',
            path: '/staff',
            component: () => import('@/views/MenuPage/Staff/StaffManagement.vue'),
        },
        {
            name: 'History Last Event',
            path: '/history-last-event',
        ...
        // },
        {
            ...
            path: '/setting',
            component: () => import('@/views/MenuPage/Setting/AccountSettings.vue'),
            meta: { requiresAuth: false }, // ทุกคนสามารถเข้าถึงได้
        },

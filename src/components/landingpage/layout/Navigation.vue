...
<template>
    ...
    <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" rounded="pill"  :ripple="false" href="https://demos.wrappixel.com/premium-admin-templates/vuejs/spike-vue/docs/index.html" target="_blank">Documentation</v-btn>
    <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" rounded="pill" :ripple="false" href="https://wrappixel.com/support/" target="_blank">Support</v-btn>
